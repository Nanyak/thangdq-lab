...
func (a *Auth) RefreshToken(ctx context.Context, refreshToken, username string) (*entity.AuthTokens, error) {
	return a.provider.RefreshToken(ctx, refreshToken, username)
}
